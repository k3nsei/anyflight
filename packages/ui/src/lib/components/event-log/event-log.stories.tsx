...
export const Story01 = ({ children: data, initiallyExpanded }: ComponentProps<typeof EventLog>) => {
  ...
  return <EventLog initiallyExpanded={initiallyExpanded}>{formatList([data, extraData])}</EventLog>;
};
