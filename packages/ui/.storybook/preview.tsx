...
export const decorators: DecoratorFn[] = [
  (Story) => {
    const { darkModeEnabled, darkModeForced, setDarkModeUserPreference } = useAnyflightUiDarkMode();

    const updateUserPreference = () => {
      if (darkModeForced !== (theme === 'dark')) {
    ...
    return <AnyflightUiThemeProvider theme={darkModeEnabled ? defaultTheme : defaultTheme} children={<Story />} />;
  },
