...
import { AnyflightThemeProvider, DarkModeProvider, defaultTheme, useDarkMode } from '../src';
import './preview.scss';
...
export const decorators: DecoratorFn[] = [
  (Story) => {
    ...
    return <AnyflightThemeProvider theme={isDarkModeEnabled ? defaultTheme : defaultTheme} children={<Story />} />;
  },
  (Story) => <DarkModeProvider children={<Story />} />,
];
